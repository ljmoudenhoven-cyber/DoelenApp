function Svg({ size = 22, strokeWidth = 2, className = '', children }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Scale(p) {
  return (
    <Svg {...p}>
      <path d="m16 3 4 8a6 6 0 0 1-12 0l4-8" />
      <path d="M2 21h20" />
      <path d="M7 21V11" />
      <path d="M17 21V11" />
      <path d="M12 21V3" />
...
export function Star({ size = 14, filled = false, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
